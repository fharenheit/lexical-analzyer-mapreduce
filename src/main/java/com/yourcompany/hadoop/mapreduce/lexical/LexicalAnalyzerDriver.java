...
import org.opencloudengine.flamingo.mapreduce.sample.WordcountReducer;
 ...
 * @version 0.1
 */
public class LexicalAnalyzerDriver extends org.apache.hadoop.conf.Configured implements org.apache.hadoop.util.Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new LexicalAnalyzerDriver(), args);
        System.exit(res);
    }
